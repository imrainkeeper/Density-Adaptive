...
args.best_epoch = -1
checkpoint_save_dir = '/home/rainkeeper/Projects/PycharmProjects/rain30/checkpoints_rain30_mcnn_baseline_0_FIXED15_try1'
...
def main():
    ...
    train_gt_dir = '/home/rainkeeper/Projects/Datasets/shanghaiTech/processed_CSRNet_uncrop_data_gpu' + str(args.dataset_id) +'/part_' + args.dataset + '/train_gt_FIXED_15'
    ...
    val_gt_dir = '/home/rainkeeper/Projects/Datasets/shanghaiTech/processed_CSRNet_uncrop_data_gpu' + str(args.dataset_id) + '/part_' + args.dataset + '/val_gt_FIXED_15'
    ...
    test_gt_dir = '/home/rainkeeper/Projects/Datasets/shanghaiTech/processed_CSRNet_uncrop_data_gpu' + str(args.dataset_id) + '/part_' + args.dataset + '/test_gt_FIXED_15'
