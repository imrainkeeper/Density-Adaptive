#################################################
# multi-column cnn 的 baseline
#################################################

import sys
import os
import warnings
# import models.net_mcnn_baseline
...
import json
import cv2
from data.data_loader_mcnn_baseline import ImageDataset
from models.net_mcnn_baseline import net
import time
...
args.best_epoch = -1
checkpoint_save_dir = '/home/rainkeeper/Projects/PycharmProjects/rain30/checkpoints_rain30_mcnn_baseline_0_ADAPTIVE_try1'
...
def main():
    ...
    train_gt_dir = '/home/rainkeeper/Projects/Datasets/shanghaiTech/processed_CSRNet_uncrop_data_gpu' + str(args.dataset_id) +'/part_' + args.dataset + '/train_gt_ADAPTIVE_0'
    ...
    val_gt_dir = '/home/rainkeeper/Projects/Datasets/shanghaiTech/processed_CSRNet_uncrop_data_gpu' + str(args.dataset_id) + '/part_' + args.dataset + '/val_gt_ADAPTIVE_0'
    ...
    test_gt_dir = '/home/rainkeeper/Projects/Datasets/shanghaiTech/processed_CSRNet_uncrop_data_gpu' + str(args.dataset_id) + '/part_' + args.dataset + '/test_gt_ADAPTIVE_0'
...
def train(train_image_dir, train_gt_dir, model, criterion, optimizer, epoch):
    ...
    for i, (img, gt_density_map) in enumerate(train_loader):
        ...
        predict_density_map = model(img)  # predict的shape为[64, 2]
