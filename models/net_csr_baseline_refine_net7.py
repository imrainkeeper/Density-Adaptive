...
class net(nn.Module):
    def __init__(self, load_weights=True):
        ...
        self.refine_encoder = nn.Sequential(nn.Conv2d(1, 128, kernel_size=3, padding=1),
        ...
        self.refine_decoder = nn.Sequential(nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2),
                                            nn.ReLU(inplace=True),
