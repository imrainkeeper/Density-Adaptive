...
class net(nn.Module):
    def __init__(self, load_weights=True):
        ...
        self.e1 = nn.Sequential(nn.Conv2d(8, 128, kernel_size=3, padding=1),
        ...
        self.t2 = nn.Sequential(nn.ConvTranspose2d(256, 128, kernel_size=2, stride=2),
                                nn.ReLU(inplace=True))
        self.d2 = nn.Sequential(nn.Conv2d(256, 64, kernel_size=3, padding=1),
                                nn.ReLU(inplace=True))
    ...
    def forward(self, image, mini_image, point_map):
        ...
        e1_feature = self.e1(fused_image)                   # 128
